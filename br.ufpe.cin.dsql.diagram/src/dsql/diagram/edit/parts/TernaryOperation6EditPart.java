 ...
 * @generated
 */
public class TernaryOperation6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TernaryOperation6EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Ternary_3027, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.TernaryOperation6EditPart.VISUAL_ID));
		}
		return parser;
	}
