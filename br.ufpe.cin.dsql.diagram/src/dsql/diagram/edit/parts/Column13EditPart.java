...
import dsql.diagram.edit.policies.Column13GraphicalNodeEditPolicy;
import dsql.diagram.edit.policies.Column13ItemSemanticEditPolicy;
import dsql.diagram.part.DsqlVisualIDRegistry;

/**
 * @generated
 */
public class Column13EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Column13EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Column13ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new Column13GraphicalNodeEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ColumnName13EditPart) {
			((ColumnName13EditPart) childEditPart).setLabel(getPrimaryShape().getFigureColumnLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(ColumnName13EditPart.VISUAL_ID));
	}
	...
	public class ColumnFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			Column column = ((Column) ((Node) Column13EditPart.this.getModel()).getElement());
			if(column != null){
				//field
