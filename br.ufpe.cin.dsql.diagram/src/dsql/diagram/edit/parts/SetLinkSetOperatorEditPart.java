...
import dsql.impl.SetLinkImpl;

/**
 * @generated
 */
public class SetLinkSetOperatorEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.SetLinkSetOperatorEditPart.VISUAL_ID),
				new Point(0, -8));
	}
	...
	* @generated
	*/
	public SetLinkSetOperatorEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void setLabelTextHelper(IFigure figure, String text) {
		SetLinkImpl sl = ((SetLinkImpl) ((Node) this.getModel()).getElement());
		
		if(sl.getSetQuantifier() == SetQuantifier.DISTINCT){
			text = " #";
		} else {
			text = "";
		}
	...
	*/
	protected void setLabelIconHelper(IFigure figure, Image icon) {
		...
		SetOperator setOperator = ((SetLinkImpl) ((Node) this.getModel()).getElement()).getSetOperator();
		
		Bundle bundle = Platform.getBundle("br.ufpe.cin.dsql.diagram");
		URL fullPathString = null;
		
		if(setOperator == SetOperator.INTERSECT){
			fullPathString = BundleUtility.find(bundle, "icons/setoperator/intersect.png");
		}
		if(setOperator  == SetOperator.EXCEPT ){
			fullPathString = BundleUtility.find(bundle, "icons/setoperator/except.png");
		}		
		if(setOperator  == SetOperator.UNION ){
			fullPathString = BundleUtility.find(bundle, "icons/setoperator/union.png");
		}
		if(setOperator  == SetOperator.EXCLUSIVE_UNION ){
			fullPathString = BundleUtility.find(bundle, "icons/setoperator/exclusive_union.png");
		}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.SetLink_4001, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.SetLinkSetOperatorEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected void handleNotificationEvent(Notification event) {
		...
		if (event.getEventType() == Notification.SET) {
			if (event.getNotifier() instanceof SetLinkImpl) {
				if (event.getFeature() instanceof EAttribute) {
					...
					if (atributo.getName().equalsIgnoreCase("setQuantifier")) {
						refreshLabel();
					}
				}
			}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SetLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SetLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SetLinkLabelFigure() {
			this.setText("SetLink");
		}
