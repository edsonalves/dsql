 ...
 * @generated
 */
public class UnaryOperation3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnaryOperation3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Unary_3009, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.UnaryOperation3EditPart.VISUAL_ID));
		}
		return parser;
	}
