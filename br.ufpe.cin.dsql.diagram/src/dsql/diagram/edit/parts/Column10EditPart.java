...
import dsql.diagram.edit.policies.Column10GraphicalNodeEditPolicy;
import dsql.diagram.edit.policies.Column10ItemSemanticEditPolicy;
import dsql.diagram.part.DsqlVisualIDRegistry;

/**
 * @generated
 */
public class Column10EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Column10EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Column10ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new Column10GraphicalNodeEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ColumnName10EditPart) {
			((ColumnName10EditPart) childEditPart).setLabel(getPrimaryShape().getFigureColumnLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(ColumnName10EditPart.VISUAL_ID));
	}
	...
	public class ColumnFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			Column column = ((Column) ((Node) Column10EditPart.this.getModel()).getElement());
			if(column != null){
				//field
