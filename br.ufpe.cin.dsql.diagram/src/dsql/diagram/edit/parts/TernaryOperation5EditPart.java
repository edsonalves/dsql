 ...
 * @generated
 */
public class TernaryOperation5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TernaryOperation5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Ternary_3024, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.TernaryOperation5EditPart.VISUAL_ID));
		}
		return parser;
	}
