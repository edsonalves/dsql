...
import dsql.diagram.edit.policies.Unary6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Unary6EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Unary6EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Unary6ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnaryOperation6EditPart) {
			((UnaryOperation6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureUnaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof UnaryUnaryOperand1Compartment6EditPart) {
			IFigure pane = getPrimaryShape().getUnaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((UnaryUnaryOperand1Compartment6EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UnaryUnaryOperand1Compartment6EditPart) {
			IFigure pane = getPrimaryShape().getUnaryOperand1CompartmentFigure();
			pane.remove(((UnaryUnaryOperand1Compartment6EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof UnaryUnaryOperand1Compartment6EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(UnaryOperation6EditPart.VISUAL_ID));
	}
