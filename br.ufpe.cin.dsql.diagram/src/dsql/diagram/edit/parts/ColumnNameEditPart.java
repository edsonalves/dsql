 ...
 * @generated
 */
public class ColumnNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ColumnNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Column_3001, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.ColumnNameEditPart.VISUAL_ID));
		}
		return parser;
	}
