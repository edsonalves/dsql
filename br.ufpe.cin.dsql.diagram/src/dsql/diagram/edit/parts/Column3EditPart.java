...
import dsql.diagram.edit.policies.Column3GraphicalNodeEditPolicy;
import dsql.diagram.edit.policies.Column3ItemSemanticEditPolicy;
import dsql.diagram.part.DsqlVisualIDRegistry;

/**
 * @generated
 */
public class Column3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Column3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Column3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new Column3GraphicalNodeEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ColumnName3EditPart) {
			((ColumnName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureColumnLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(ColumnName3EditPart.VISUAL_ID));
	}
