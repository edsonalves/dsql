 ...
 * @generated
 */
public class BinaryOperation9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BinaryOperation9EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Binary_3035, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.BinaryOperation9EditPart.VISUAL_ID));
		}
		return parser;
	}
