 ...
 * @generated
 */
public class ColumnName5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ColumnName5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Column_3008, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.ColumnName5EditPart.VISUAL_ID));
		}
		return parser;
	}
