 ...
 * @generated
 */
public class TernaryOperation3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TernaryOperation3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Ternary_3018, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.TernaryOperation3EditPart.VISUAL_ID));
		}
		return parser;
	}
