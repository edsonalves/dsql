 ...
 * @generated
 */
public class BinaryOperation3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BinaryOperation3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Binary_3016, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.BinaryOperation3EditPart.VISUAL_ID));
		}
		return parser;
	}
