 ...
 * @generated
 */
public class ColumnName13EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ColumnName13EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Column_3050, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.ColumnName13EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected void handleNotificationEvent(Notification event) {
		if (event.getEventType() == Notification.SET && event.getFeature() instanceof EReference) {
			...
			if (reference.getName().equals("conditionalExpressionLink") || reference.getName().equals("logicalLink")) {
				refreshLabel();
			}
		}
