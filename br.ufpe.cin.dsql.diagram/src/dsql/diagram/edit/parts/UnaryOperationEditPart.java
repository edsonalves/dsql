 ...
 * @generated
 */
public class UnaryOperationEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnaryOperationEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Unary_3003, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.UnaryOperationEditPart.VISUAL_ID));
		}
		return parser;
	}
