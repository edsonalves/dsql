...
import dsql.diagram.edit.policies.Ternary8ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ternary8EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Ternary8EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Ternary8ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TernaryOperation8EditPart) {
			((TernaryOperation8EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTernaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand1Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TernaryTernaryOperand1Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand2Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand2CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TernaryTernaryOperand2Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand3Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand3CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TernaryTernaryOperand3Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TernaryTernaryOperand1Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand1CompartmentFigure();
			pane.remove(((TernaryTernaryOperand1Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand2Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand2CompartmentFigure();
			pane.remove(((TernaryTernaryOperand2Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand3Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand3CompartmentFigure();
			pane.remove(((TernaryTernaryOperand3Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof TernaryTernaryOperand1Compartment8EditPart) {
			return getPrimaryShape().getTernaryOperand1CompartmentFigure();
		}
		if (editPart instanceof TernaryTernaryOperand2Compartment8EditPart) {
			return getPrimaryShape().getTernaryOperand2CompartmentFigure();
		}
		if (editPart instanceof TernaryTernaryOperand3Compartment8EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(TernaryOperation8EditPart.VISUAL_ID));
	}
