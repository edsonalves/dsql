 ...
 * @generated
 */
public class TernaryOperation9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TernaryOperation9EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Ternary_3036, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.TernaryOperation9EditPart.VISUAL_ID));
		}
		return parser;
	}
