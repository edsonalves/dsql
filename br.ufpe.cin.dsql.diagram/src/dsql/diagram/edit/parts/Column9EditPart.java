...
import dsql.diagram.edit.policies.Column9GraphicalNodeEditPolicy;
import dsql.diagram.edit.policies.Column9ItemSemanticEditPolicy;
import dsql.diagram.part.DsqlVisualIDRegistry;

/**
 * @generated
 */
public class Column9EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Column9EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Column9ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new Column9GraphicalNodeEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ColumnName9EditPart) {
			((ColumnName9EditPart) childEditPart).setLabel(getPrimaryShape().getFigureColumnLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(ColumnName9EditPart.VISUAL_ID));
	}
