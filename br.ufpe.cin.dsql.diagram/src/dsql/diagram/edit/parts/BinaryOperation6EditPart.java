 ...
 * @generated
 */
public class BinaryOperation6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BinaryOperation6EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Binary_3026, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.BinaryOperation6EditPart.VISUAL_ID));
		}
		return parser;
	}
