 ...
 * @generated
 */
public class ElseLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ElseLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Else_2002, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.ElseLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
