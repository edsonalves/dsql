...
import dsql.diagram.edit.policies.Column6GraphicalNodeEditPolicy;
import dsql.diagram.edit.policies.Column6ItemSemanticEditPolicy;
import dsql.diagram.part.DsqlVisualIDRegistry;

/**
 * @generated
 */
public class Column6EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Column6EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Column6ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new Column6GraphicalNodeEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ColumnName6EditPart) {
			((ColumnName6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureColumnLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(ColumnName6EditPart.VISUAL_ID));
	}
