...
import dsql.diagram.edit.policies.Unary10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Unary10EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Unary10EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Unary10ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnaryOperation10EditPart) {
			((UnaryOperation10EditPart) childEditPart).setLabel(getPrimaryShape().getFigureUnaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof UnaryUnaryOperand1Compartment10EditPart) {
			IFigure pane = getPrimaryShape().getUnaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((UnaryUnaryOperand1Compartment10EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UnaryUnaryOperand1Compartment10EditPart) {
			IFigure pane = getPrimaryShape().getUnaryOperand1CompartmentFigure();
			pane.remove(((UnaryUnaryOperand1Compartment10EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof UnaryUnaryOperand1Compartment10EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(UnaryOperation10EditPart.VISUAL_ID));
	}
