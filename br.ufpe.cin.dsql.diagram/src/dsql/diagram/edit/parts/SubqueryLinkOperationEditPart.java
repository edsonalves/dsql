...
import dsql.impl.SubqueryLinkImpl;

/**
 * @generated
 */
public class SubqueryLinkOperationEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.SubqueryLinkOperationEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public SubqueryLinkOperationEditPart(View view) {
		super(view);
	}
	...
	*/
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			text = ((SubqueryLinkImpl) parserElement).getOperation().getLiteral();
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.SubqueryLink_4004, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.SubqueryLinkOperationEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SubqueryLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SubqueryLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SubqueryLinkLabelFigure() {
			this.setText("SubqueryLink");
		}
