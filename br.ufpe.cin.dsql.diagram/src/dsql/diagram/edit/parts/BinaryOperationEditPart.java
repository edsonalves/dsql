 ...
 * @generated
 */
public class BinaryOperationEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BinaryOperationEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Binary_3006, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.BinaryOperationEditPart.VISUAL_ID));
		}
		return parser;
	}
