 ...
 * @generated
 */
public class UnaryOperation7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnaryOperation7EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Unary_3025, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.UnaryOperation7EditPart.VISUAL_ID));
		}
		return parser;
	}
