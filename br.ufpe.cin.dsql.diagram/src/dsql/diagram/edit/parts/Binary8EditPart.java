...
import dsql.diagram.edit.policies.Binary8ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Binary8EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Binary8EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Binary8ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BinaryOperation8EditPart) {
			((BinaryOperation8EditPart) childEditPart).setLabel(getPrimaryShape().getFigureBinaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand1Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((BinaryBinaryOperand1Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand2Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand2CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((BinaryBinaryOperand2Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BinaryBinaryOperand1Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand1CompartmentFigure();
			pane.remove(((BinaryBinaryOperand1Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand2Compartment8EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand2CompartmentFigure();
			pane.remove(((BinaryBinaryOperand2Compartment8EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof BinaryBinaryOperand1Compartment8EditPart) {
			return getPrimaryShape().getBinaryOperand1CompartmentFigure();
		}
		if (editPart instanceof BinaryBinaryOperand2Compartment8EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(BinaryOperation8EditPart.VISUAL_ID));
	}
