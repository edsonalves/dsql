 ...
 * @generated
 */
public class UnaryOperation2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnaryOperation2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Unary_3005, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.UnaryOperation2EditPart.VISUAL_ID));
		}
		return parser;
	}
