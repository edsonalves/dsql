...
import dsql.diagram.edit.policies.Unary11ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Unary11EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Unary11EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Unary11ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnaryOperation11EditPart) {
			((UnaryOperation11EditPart) childEditPart).setLabel(getPrimaryShape().getFigureUnaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof UnaryUnaryOperand1Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getUnaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((UnaryUnaryOperand1Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UnaryUnaryOperand1Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getUnaryOperand1CompartmentFigure();
			pane.remove(((UnaryUnaryOperand1Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof UnaryUnaryOperand1Compartment11EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(UnaryOperation11EditPart.VISUAL_ID));
	}
