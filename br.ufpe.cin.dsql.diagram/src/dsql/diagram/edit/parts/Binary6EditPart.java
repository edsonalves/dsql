...
import dsql.diagram.edit.policies.Binary6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Binary6EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Binary6EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Binary6ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BinaryOperation6EditPart) {
			((BinaryOperation6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureBinaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand1Compartment6EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((BinaryBinaryOperand1Compartment6EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand2Compartment6EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand2CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((BinaryBinaryOperand2Compartment6EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BinaryBinaryOperand1Compartment6EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand1CompartmentFigure();
			pane.remove(((BinaryBinaryOperand1Compartment6EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand2Compartment6EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand2CompartmentFigure();
			pane.remove(((BinaryBinaryOperand2Compartment6EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof BinaryBinaryOperand1Compartment6EditPart) {
			return getPrimaryShape().getBinaryOperand1CompartmentFigure();
		}
		if (editPart instanceof BinaryBinaryOperand2Compartment6EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(BinaryOperation6EditPart.VISUAL_ID));
	}
