 ...
 * @generated
 */
public class ColumnName8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ColumnName8EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Column_3013, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.ColumnName8EditPart.VISUAL_ID));
		}
		return parser;
	}
