...
import dsql.diagram.edit.policies.Ternary11ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ternary11EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Ternary11EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Ternary11ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TernaryOperation11EditPart) {
			((TernaryOperation11EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTernaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand1Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TernaryTernaryOperand1Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand2Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand2CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TernaryTernaryOperand2Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand3Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand3CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TernaryTernaryOperand3Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TernaryTernaryOperand1Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand1CompartmentFigure();
			pane.remove(((TernaryTernaryOperand1Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand2Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand2CompartmentFigure();
			pane.remove(((TernaryTernaryOperand2Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand3Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand3CompartmentFigure();
			pane.remove(((TernaryTernaryOperand3Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof TernaryTernaryOperand1Compartment11EditPart) {
			return getPrimaryShape().getTernaryOperand1CompartmentFigure();
		}
		if (editPart instanceof TernaryTernaryOperand2Compartment11EditPart) {
			return getPrimaryShape().getTernaryOperand2CompartmentFigure();
		}
		if (editPart instanceof TernaryTernaryOperand3Compartment11EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(TernaryOperation11EditPart.VISUAL_ID));
	}
