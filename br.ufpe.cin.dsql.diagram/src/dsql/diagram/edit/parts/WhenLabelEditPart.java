 ...
 * @generated
 */
public class WhenLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public WhenLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.When_2001, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.WhenLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
