...
import dsql.diagram.edit.policies.ColumnGraphicalNodeEditPolicy;
import dsql.diagram.edit.policies.ColumnItemSemanticEditPolicy;
...
public class ColumnEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ColumnNameEditPart) {
			((ColumnNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureColumnLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(ColumnNameEditPart.VISUAL_ID));
	}
	...
	public class ColumnFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			Column column = ((Column) ((Node) ColumnEditPart.this.getModel()).getElement());
			if(column != null){
				//field
