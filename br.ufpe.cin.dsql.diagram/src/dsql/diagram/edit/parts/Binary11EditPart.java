...
import dsql.diagram.edit.policies.Binary11ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Binary11EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Binary11EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Binary11ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BinaryOperation11EditPart) {
			((BinaryOperation11EditPart) childEditPart).setLabel(getPrimaryShape().getFigureBinaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand1Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((BinaryBinaryOperand1Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand2Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand2CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((BinaryBinaryOperand2Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BinaryBinaryOperand1Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand1CompartmentFigure();
			pane.remove(((BinaryBinaryOperand1Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand2Compartment11EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand2CompartmentFigure();
			pane.remove(((BinaryBinaryOperand2Compartment11EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof BinaryBinaryOperand1Compartment11EditPart) {
			return getPrimaryShape().getBinaryOperand1CompartmentFigure();
		}
		if (editPart instanceof BinaryBinaryOperand2Compartment11EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(BinaryOperation11EditPart.VISUAL_ID));
	}
