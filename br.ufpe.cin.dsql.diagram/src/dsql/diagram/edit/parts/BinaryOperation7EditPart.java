 ...
 * @generated
 */
public class BinaryOperation7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BinaryOperation7EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Binary_3028, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.BinaryOperation7EditPart.VISUAL_ID));
		}
		return parser;
	}
