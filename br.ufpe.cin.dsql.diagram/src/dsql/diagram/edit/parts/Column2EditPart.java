...
import dsql.diagram.edit.policies.Column2GraphicalNodeEditPolicy;
import dsql.diagram.edit.policies.Column2ItemSemanticEditPolicy;
...
public class Column2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new Column2GraphicalNodeEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ColumnName2EditPart) {
			((ColumnName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureColumnLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(ColumnName2EditPart.VISUAL_ID));
	}
