...
import dsql.diagram.edit.policies.UnaryItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UnaryEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public UnaryEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnaryItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnaryOperationEditPart) {
			((UnaryOperationEditPart) childEditPart).setLabel(getPrimaryShape().getFigureUnaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof UnaryUnaryOperand1CompartmentEditPart) {
			IFigure pane = getPrimaryShape().getUnaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((UnaryUnaryOperand1CompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UnaryUnaryOperand1CompartmentEditPart) {
			IFigure pane = getPrimaryShape().getUnaryOperand1CompartmentFigure();
			pane.remove(((UnaryUnaryOperand1CompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof UnaryUnaryOperand1CompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(UnaryOperationEditPart.VISUAL_ID));
	}
