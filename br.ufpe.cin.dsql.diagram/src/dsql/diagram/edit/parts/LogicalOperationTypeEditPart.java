 ...
 * @generated
 */
public class LogicalOperationTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LogicalOperationTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.LogicalOperation_2004, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.LogicalOperationTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
