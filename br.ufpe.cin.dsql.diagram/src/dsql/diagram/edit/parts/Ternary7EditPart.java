...
import dsql.diagram.edit.policies.Ternary7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Ternary7EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Ternary7EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Ternary7ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TernaryOperation7EditPart) {
			((TernaryOperation7EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTernaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand1Compartment7EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TernaryTernaryOperand1Compartment7EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand2Compartment7EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand2CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TernaryTernaryOperand2Compartment7EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand3Compartment7EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand3CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TernaryTernaryOperand3Compartment7EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TernaryTernaryOperand1Compartment7EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand1CompartmentFigure();
			pane.remove(((TernaryTernaryOperand1Compartment7EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand2Compartment7EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand2CompartmentFigure();
			pane.remove(((TernaryTernaryOperand2Compartment7EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TernaryTernaryOperand3Compartment7EditPart) {
			IFigure pane = getPrimaryShape().getTernaryOperand3CompartmentFigure();
			pane.remove(((TernaryTernaryOperand3Compartment7EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof TernaryTernaryOperand1Compartment7EditPart) {
			return getPrimaryShape().getTernaryOperand1CompartmentFigure();
		}
		if (editPart instanceof TernaryTernaryOperand2Compartment7EditPart) {
			return getPrimaryShape().getTernaryOperand2CompartmentFigure();
		}
		if (editPart instanceof TernaryTernaryOperand3Compartment7EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(TernaryOperation7EditPart.VISUAL_ID));
	}
