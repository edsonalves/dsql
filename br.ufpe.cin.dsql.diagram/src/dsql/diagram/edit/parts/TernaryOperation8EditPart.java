 ...
 * @generated
 */
public class TernaryOperation8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TernaryOperation8EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Ternary_3032, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.TernaryOperation8EditPart.VISUAL_ID));
		}
		return parser;
	}
