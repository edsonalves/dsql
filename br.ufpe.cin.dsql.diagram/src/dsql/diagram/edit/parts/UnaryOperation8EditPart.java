 ...
 * @generated
 */
public class UnaryOperation8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnaryOperation8EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Unary_3030, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.UnaryOperation8EditPart.VISUAL_ID));
		}
		return parser;
	}
