 ...
 * @generated
 */
public class ColumnName6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ColumnName6EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DsqlParserProvider.getParser(DsqlElementTypes.Column_3011, getParserElement(),
					DsqlVisualIDRegistry.getType(dsql.diagram.edit.parts.ColumnName6EditPart.VISUAL_ID));
		}
		return parser;
	}
