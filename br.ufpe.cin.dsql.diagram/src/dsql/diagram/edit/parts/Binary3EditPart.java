...
import dsql.diagram.edit.policies.Binary3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Binary3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Binary3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Binary3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BinaryOperation3EditPart) {
			((BinaryOperation3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureBinaryLabelFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand1Compartment3EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand1CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((BinaryBinaryOperand1Compartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand2Compartment3EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand2CompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((BinaryBinaryOperand2Compartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BinaryBinaryOperand1Compartment3EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand1CompartmentFigure();
			pane.remove(((BinaryBinaryOperand1Compartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof BinaryBinaryOperand2Compartment3EditPart) {
			IFigure pane = getPrimaryShape().getBinaryOperand2CompartmentFigure();
			pane.remove(((BinaryBinaryOperand2Compartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof BinaryBinaryOperand1Compartment3EditPart) {
			return getPrimaryShape().getBinaryOperand1CompartmentFigure();
		}
		if (editPart instanceof BinaryBinaryOperand2Compartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsqlVisualIDRegistry.getType(BinaryOperation3EditPart.VISUAL_ID));
	}
