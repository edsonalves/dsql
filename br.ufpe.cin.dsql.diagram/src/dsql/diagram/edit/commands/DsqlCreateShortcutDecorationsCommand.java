 ...
 * @generated
 */
public class DsqlCreateShortcutDecorationsCommand extends AbstractTransactionalCommand {
	...
	* @generated
	*/
	public DsqlCreateShortcutDecorationsCommand(TransactionalEditingDomain editingDomain, View parentView,
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put("modelID", QueryDiagramEditPart.MODEL_ID); //$NON-NLS-1$
