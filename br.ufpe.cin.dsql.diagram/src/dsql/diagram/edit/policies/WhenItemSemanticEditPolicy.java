...
import dsql.diagram.edit.parts.WhenWhenConditionCompartmentEditPart;
import dsql.diagram.edit.parts.WhenWhenResultCompartmentEditPart;
 ...
 * @generated
 */
public class WhenItemSemanticEditPolicy extends DsqlBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public WhenItemSemanticEditPolicy() {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DsqlVisualIDRegistry.getVisualID(incomingLink) == ConditionalExpressionLinkEditPart.VISUAL_ID) {
