 ...
 * @generated
 */
public class UnaryUnaryOperand1Compartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7007SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7007SemanticChildren((View) getHost().getModel());
