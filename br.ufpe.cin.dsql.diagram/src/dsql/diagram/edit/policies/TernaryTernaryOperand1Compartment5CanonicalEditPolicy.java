 ...
 * @generated
 */
public class TernaryTernaryOperand1Compartment5CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand1Compartment_7031SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand1Compartment_7031SemanticChildren((View) getHost().getModel());
