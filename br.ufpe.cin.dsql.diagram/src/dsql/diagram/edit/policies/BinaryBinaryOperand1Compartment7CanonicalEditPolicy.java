 ...
 * @generated
 */
public class BinaryBinaryOperand1Compartment7CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand1Compartment_7040SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand1Compartment_7040SemanticChildren((View) getHost().getModel());
