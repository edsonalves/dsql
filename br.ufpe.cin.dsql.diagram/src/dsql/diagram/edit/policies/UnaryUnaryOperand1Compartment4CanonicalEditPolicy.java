 ...
 * @generated
 */
public class UnaryUnaryOperand1Compartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7011SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7011SemanticChildren((View) getHost().getModel());
