 ...
 * @generated
 */
public class TernaryTernaryOperand2Compartment6CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand2Compartment_7038SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand2Compartment_7038SemanticChildren((View) getHost().getModel());
