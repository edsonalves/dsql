 ...
 * @generated
 */
public class LogicalOperationLogicalOperationExpressionsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsqlPackage.eINSTANCE.getLogicalOperation_Expressions();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getLogicalOperationLogicalOperationExpressionsCompartment_7079SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getLogicalOperationLogicalOperationExpressionsCompartment_7079SemanticChildren(
