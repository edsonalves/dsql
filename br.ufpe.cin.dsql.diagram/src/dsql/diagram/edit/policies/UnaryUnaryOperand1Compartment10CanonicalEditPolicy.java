 ...
 * @generated
 */
public class UnaryUnaryOperand1Compartment10CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7061SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7061SemanticChildren((View) getHost().getModel());
