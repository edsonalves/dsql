 ...
 * @generated
 */
public class BinaryBinaryOperand1Compartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand1Compartment_7014SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand1Compartment_7014SemanticChildren((View) getHost().getModel());
