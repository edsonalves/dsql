 ...
 * @generated
 */
public class BinaryBinaryOperand1Compartment11CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand1Compartment_7068SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand1Compartment_7068SemanticChildren((View) getHost().getModel());
