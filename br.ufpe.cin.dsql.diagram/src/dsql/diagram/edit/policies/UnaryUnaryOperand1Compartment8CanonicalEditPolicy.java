 ...
 * @generated
 */
public class UnaryUnaryOperand1Compartment8CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7045SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7045SemanticChildren((View) getHost().getModel());
