 ...
 * @generated
 */
public class BinaryBinaryOperand2Compartment6CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand2Compartment_7036SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand2Compartment_7036SemanticChildren((View) getHost().getModel());
