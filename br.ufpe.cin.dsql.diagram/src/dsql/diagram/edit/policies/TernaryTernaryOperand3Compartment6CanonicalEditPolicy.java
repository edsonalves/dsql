 ...
 * @generated
 */
public class TernaryTernaryOperand3Compartment6CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand3Compartment_7039SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand3Compartment_7039SemanticChildren((View) getHost().getModel());
