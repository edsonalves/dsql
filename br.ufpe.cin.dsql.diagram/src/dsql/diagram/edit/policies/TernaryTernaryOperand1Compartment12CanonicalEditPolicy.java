 ...
 * @generated
 */
public class TernaryTernaryOperand1Compartment12CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand1Compartment_7076SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand1Compartment_7076SemanticChildren((View) getHost().getModel());
