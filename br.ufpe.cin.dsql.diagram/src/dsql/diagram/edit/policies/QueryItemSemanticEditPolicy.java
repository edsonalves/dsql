...
import dsql.diagram.edit.commands.SetLinkCreateCommand;
import dsql.diagram.edit.commands.SetLinkReorientCommand;
...
import dsql.diagram.edit.parts.QueryQueryFromCompartmentEditPart;
import dsql.diagram.edit.parts.QueryQuerySelectCompartmentEditPart;
import dsql.diagram.edit.parts.QueryQueryWhereHavingCompartmentEditPart;
 ...
 * @generated
 */
public class QueryItemSemanticEditPolicy extends DsqlBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DsqlVisualIDRegistry.getVisualID(incomingLink) == SetLinkEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DsqlVisualIDRegistry.getVisualID(outgoingLink) == SetLinkEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
			}
			if (DsqlVisualIDRegistry.getVisualID(outgoingLink) == SubqueryLinkEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (DsqlElementTypes.SetLink_4001 == req.getElementType()) {
			return getGEFWrapper(new SetLinkCreateCommand(req, req.getSource(), req.getTarget()));
		}
	...
	protected Command getReorientRelationshipCommand(ReorientRelationshipRequest req) {
		...
		case SetLinkEditPart.VISUAL_ID:
			return getGEFWrapper(new SetLinkReorientCommand(req));
