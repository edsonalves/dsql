 ...
 * @generated
 */
public class TernaryTernaryOperand3CompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand3Compartment_7010SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getTernaryTernaryOperand3Compartment_7010SemanticChildren((View) getHost().getModel());
