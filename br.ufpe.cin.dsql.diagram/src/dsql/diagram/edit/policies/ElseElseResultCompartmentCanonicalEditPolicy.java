 ...
 * @generated
 */
public class ElseElseResultCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsqlPackage.eINSTANCE.getElse_Result();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getElseElseResultCompartment_7051SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getElseElseResultCompartment_7051SemanticChildren((View) getHost().getModel());
