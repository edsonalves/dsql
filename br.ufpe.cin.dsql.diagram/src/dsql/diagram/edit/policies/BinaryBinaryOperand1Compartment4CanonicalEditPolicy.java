 ...
 * @generated
 */
public class BinaryBinaryOperand1Compartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand1Compartment_7023SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getBinaryBinaryOperand1Compartment_7023SemanticChildren((View) getHost().getModel());
