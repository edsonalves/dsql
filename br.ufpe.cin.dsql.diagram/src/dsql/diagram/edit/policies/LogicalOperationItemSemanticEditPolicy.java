...
import dsql.diagram.edit.parts.LogicalOperationLogicalOperationExpressionsCompartmentEditPart;
 ...
 * @generated
 */
public class LogicalOperationItemSemanticEditPolicy extends DsqlBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public LogicalOperationItemSemanticEditPolicy() {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DsqlVisualIDRegistry.getVisualID(incomingLink) == LogicalLinkEditPart.VISUAL_ID) {
