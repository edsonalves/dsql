 ...
 * @generated
 */
public class UnaryUnaryOperand1Compartment7CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7034SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DsqlNodeDescriptor> childDescriptors = DsqlDiagramUpdater
				.getUnaryUnaryOperand1Compartment_7034SemanticChildren((View) getHost().getModel());
